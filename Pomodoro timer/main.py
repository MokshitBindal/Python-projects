...
def count_down(count):
    ...
    if count_sec in range(0,10):
        ...
        # this is dynamic typing where same variable can be assigned multiple types of data types
...
#     time.sleep()
#     count -= 1
# cant have a loop here as the tkinter is already in a mainloop that wants to works every millisecond
...
# image size is 200x223 but we are working with even numbers
tomato_img = PhotoImage(file="tomato.png")
canvas.create_image(100, 112, image=tomato_img)
# image was shifted a little so we adjusted the size accordingly
